...
TotemData[TT_DISEASE_CLEANSING].duration = 300;
...
TotemData[TT_FROST_RESISTANCE].duration = 300;
...
TotemData[TT_GRACE_OF_AIR].duration = 300;
--TotemData[TT_GRACE_OF_AIR][1] = { };
--TotemData[TT_GRACE_OF_AIR][1].duration = 300;
--TotemData[TT_GRACE_OF_AIR][2] = { };
--TotemData[TT_GRACE_OF_AIR][2].duration = 300;
--TotemData[TT_GRACE_OF_AIR][3] = { };
--TotemData[TT_GRACE_OF_AIR][3].duration = 300;
...
TotemData[TT_HEALING_STREAM].duration = 60;
...
TotemData[TT_NATURE_RESISTANCE].duration = 300;
...
TotemData[TT_POISON_CLEANSING].duration = 300;
...
TotemData[TT_STONECLAW][1].hits = 206;
TotemData[TT_STONECLAW][2] = { };
TotemData[TT_STONECLAW][2].hits = 276;
TotemData[TT_STONECLAW][3] = { };
TotemData[TT_STONECLAW][3].hits = 316;
TotemData[TT_STONECLAW][4] = { };
TotemData[TT_STONECLAW][4].hits = 346;
TotemData[TT_STONECLAW][5] = { };
TotemData[TT_STONECLAW][5].hits = 426;
TotemData[TT_STONECLAW][6] = { };
TotemData[TT_STONECLAW][6].hits = 486;

TotemData[TT_STONESKIN] = {};
TotemData[TT_STONESKIN].icon = "Spell_Nature_StoneSkinTotem";
TotemData[TT_STONESKIN].hits = 5;
TotemData[TT_STONESKIN].duration = 300;
--TotemData[TT_STONESKIN][1] = { };
--TotemData[TT_STONESKIN][1].duration = 300;
--TotemData[TT_STONESKIN][2] = { };
--TotemData[TT_STONESKIN][2].duration = 300;
--TotemData[TT_STONESKIN][3] = { };
--TotemData[TT_STONESKIN][3].duration = 300;
--TotemData[TT_STONESKIN][4] = { };
--TotemData[TT_STONESKIN][4].duration = 300;
--TotemData[TT_STONESKIN][5] = { };
--TotemData[TT_STONESKIN][5].duration = 300;
--TotemData[TT_STONESKIN][6] = { };
--TotemData[TT_STONESKIN][6].duration = 300;
...
TotemData[TT_STRENGTH_OF_EARTH].duration = 300;
--TotemData[TT_STRENGTH_OF_EARTH][1] = { };
--TotemData[TT_STRENGTH_OF_EARTH][1].duration = 300;
--TotemData[TT_STRENGTH_OF_EARTH][2] = { };
--TotemData[TT_STRENGTH_OF_EARTH][2].duration = 300;
--TotemData[TT_STRENGTH_OF_EARTH][3] = { };
--TotemData[TT_STRENGTH_OF_EARTH][3].duration = 300;
--TotemData[TT_STRENGTH_OF_EARTH][4] = { };
--TotemData[TT_STRENGTH_OF_EARTH][4].duration = 300;
--TotemData[TT_STRENGTH_OF_EARTH][5] = { };
--TotemData[TT_STRENGTH_OF_EARTH][5].duration = 300;

TotemData[TT_TREMOR] = {};
TotemData[TT_TREMOR].icon = "Spell_Nature_TremorTotem";
TotemData[TT_TREMOR].duration = 20;
TotemData[TT_TREMOR].hits = 5;

TotemData[TT_TRANQUIL_AIR] = {};
TotemData[TT_TRANQUIL_AIR].icon = "Spell_Nature_Brilliance";
TotemData[TT_TRANQUIL_AIR].duration = 300;
TotemData[TT_TRANQUIL_AIR].hits = 5;

TotemData[TT_WINDFURY] = {};
TotemData[TT_WINDFURY].icon = "Spell_Nature_Windfury";
TotemData[TT_WINDFURY].duration = 300;
TotemData[TT_WINDFURY].hits = 5;

TotemData[TT_WINDWALL] = {};
TotemData[TT_WINDWALL].icon = "Spell_Nature_EarthBind";
TotemData[TT_WINDWALL].duration = 300;
